...
import ru.kpfu.itis.ya.ui.common.TopBarViewModel
import ru.kpfu.itis.ya.ui.common.ui.FabAddButton
import ru.kpfu.itis.ya.ui.common.ui.TopAppBar

/**
 * Composable-функция для главного экрана-хоста приложения.
 *
 * Single Responsibility: Отвечает только за компоновку основных UI элементов
 * (TopAppBar, BottomNavigation, FAB) и навигацию.
 */
@Suppress("LongMethod")
@Composable
fun MainHostScreen(
