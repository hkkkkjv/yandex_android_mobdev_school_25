...
import androidx.compose.ui.unit.dp
import ru.kpfu.itis.ya.ui.common.initialsFromTitle

/**
 * Composable-функция для отображения элемента списка.
 *
 * Single Responsibility: Отвечает только за отображение универсального элемента списка с настраиваемым содержимым.
 */
