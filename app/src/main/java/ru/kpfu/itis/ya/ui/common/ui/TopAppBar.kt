...
/**
 * Composable-функция для отображения верхней панели приложения.
 *
 * Single Responsibility: Отвечает только за отображение настраиваемой
 * верхней панели с заголовком, кнопками навигации и действиями.
 */
